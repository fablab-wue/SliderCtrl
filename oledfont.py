# Adafruit_GFX classic 5x7 font (column-major, bit0 = top).
# Used for OLED labels, units, and application text.
...
def text(fb, s, x, y, colour=1):
    """Draw string with the 5x7 font onto a framebuf (e.g. SSD1306)."""
    if not s:
        return
    for ch in s:
        o = ord(ch)
